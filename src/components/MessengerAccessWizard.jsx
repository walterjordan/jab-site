...
export default function MessengerAccessWizard() {
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6 p-6">
      ...
      <p className="pt-4 text-xs text-gray-500">Tip: In Development mode only app admins/developers/testers can use messaging. For production, request App Review for:
 pages_messaging, pages_manage_metadata, pages_show_list, pages_read_engagement.</p>
    </div>
  );
}
